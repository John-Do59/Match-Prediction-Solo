"""
Alembic env.py — FastAPI_App (footballapp_db)

Ce fichier connecte Alembic aux modèles SQLAlchemy pour permettre
la génération et l'application des migrations.
"""
import sys
...
# Import obligatoire de TOUS les modèles pour qu'Alembic les détecte
...
# Injection dynamique de l'URL depuis l'environnement (pas d'URL en dur)
